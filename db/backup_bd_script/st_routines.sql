...
/*!50001 CREATE TABLE `v_user_role` (
  `IdentificadorUsuario` varchar(20),
  `ContrasenaUsuario` varchar(64),
  `NombreUsuarioTipo` varchar(20)
) ENGINE=MyISAM */;
...
/*!50001 VIEW `v_user_role` AS select `u`.`IdentificadorUsuario` AS `IdentificadorUsuario`,`u`.`ContrasenaUsuario` AS `ContrasenaUsuario`,`g`.`NombreUsuarioTipo` AS `NombreUsuarioTipo` from (`st_usuario` `u` join `st_usuariotipo` `g` on((`g`.`CodigoUsuarioTipo` = `u`.`CodigoUsuarioTipo`))) */;
